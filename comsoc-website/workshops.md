...
[Call for Bids]({{ site.baseurl }}/assets/docs/call-for-bids-to-host-comsoc-2027.txt)
to host the 2027 edition of the workshop. But note that the deadline has now passed.
